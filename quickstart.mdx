...
description: "Welcome to Serververse for this guide helps you get started in 3 simple steps."
---

> Whether you're launching a website, game server, or virtual machine so follow this flow to go live fast.
...
<Warning>
  Your panel is different from the store dashboard, Each service has its own portal: Web Panel, Game Panel, or Cloud (Proxmox).
</Warning>
