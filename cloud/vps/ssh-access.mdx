...
If this is your first time connecting, you will be asked to confirm the server fingerprint.
...
* **Connection refused**
  SSH service may not be running or port 22 is blocked by a firewall.

* **Permission denied**
  Incorrect username, password, or SSH key permissions.

* **Connection timed out**
  Incorrect IP address or network-level firewall restrictions.
