...
<Card title="IMAP Sync Online" color="#ffa632" icon="mailbox" iconType="duotone" href="https://imapsync.lamiral.info/X/">
...
2. **Destination (Host 2):** Enter your Serververse IMAP details (typically `mail.serverers.com`).
...
| **Serververse** | `mail.serververs.com` | Standard Password |
